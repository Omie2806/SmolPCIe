...
logic [7 : 0] Tag;
    ...
    always_comb begin
        ...
        Header_decoder[0] = TLP_OUT[0];
        Header_decoder[1] = TLP_OUT[1];
        Header_decoder[2] = TLP_OUT[2];
        Header_decoder[3] = TLP_OUT[3];
        data_in_device[0] = TLP_OUT[4];
        data_in_device[1] = TLP_OUT[5];

        //i'll do completion DLL later
    end
